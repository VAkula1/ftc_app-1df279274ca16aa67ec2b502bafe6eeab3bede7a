...
public class TELEOPEncoderMode extends OpMode {
    ...
    public void loop() {
        ...
        bot.SetDC(gamepad1.right_bumper,gamepad1.x,gamepad1.y,gamepad1.a,gamepad1.b);
...
//        }
        ...
        telemetry.addData("CD00: ",bot.CD0);
        telemetry.addData("CD01: ",bot.CD1);
        telemetry.addData("CD02: ",bot.CD2);
        telemetry.addData("CD03: ",bot.CD3);
